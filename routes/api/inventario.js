...
router.post('/:id/movimiento', allowNegativeStock, async (req, res, next) => {
  try {
...
router.use(createCrudRouter({
  ...
  columns: ['id_categoria','id_proveedor','nombre','precio_venta','codigo_interno','codigo_barras','marca','unidad_medida','precio_compra','porcentaje_impuesto','existencia_minima','existencia_maxima','ubicacion_bodega','estado','tipo_producto'],
